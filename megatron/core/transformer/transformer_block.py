...
class TransformerBlock(MegatronModule):
            ...
            for layer_idx in range(self.num_layers_per_pipeline_rank):
                ...
                if (
                    ...
                    hidden_states, context = custom(layer_idx, layer_idx + 1)(
                        hidden_states, attention_mask, context, context_mask, rotary_pos_emb, packed_seq_params,
                    )
        else:
    ...
    def forward(
        ...
        *,
        ...
        fp8_context = outer_fp8_context if is_real_cuda_device_available() else fp8_context
