...
class MoELayer(BaseMoELayer):
    ...
    def __init__(
        ...
        self.tp_size = model_comm_pgs.tp.size()
        self.ep_size = model_comm_pgs.ep.size()
        ...
        elif config.moe_token_dispatcher_type is None:
            print(config)
    ...
    def _checkpointed_forward(
        ...
        def custom_forward(hidden_states, probs=None, routing_map=None):
    ...
    def forward(self, hidden_states: torch.Tensor):
        ...
        probs, routing_map = None, None
        if self.config.moe_dynamic_hpu:
            probs, routing_map = self.router(hidden_states)
