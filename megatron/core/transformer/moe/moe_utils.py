...
try:
    ...
    # Gracefully fall back when Transformer Engine (NVIDIA TE) is not available.
    # Define the optional symbols as None so downstream conditional checks like
    # `if te_general_gemm is not None` work without raising NameError.
    fused_permute = None
