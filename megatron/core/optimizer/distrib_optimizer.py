...
from ..utils import get_node_data_parallel_ranks, is_real_cuda_device_available, print_rank_0
...
class DistributedOptimizer(MixedPrecisionOptimizer):
    ...
    def __init__(
        ...
        try:
            ...
            FusedAdamW = None
        assert (
            isinstance(optimizer, (Adam, FusedAdamW, HybridDeviceOptimizer)) or optimizer is None
        ), "Only Adam, FusedAdamW and HybridDeviceOptimizer currently supported, due to "
    ...
    def sharded_state_dict(
        ...
        sharding_type: Optional[str] = 'fully_sharded_model_space',
