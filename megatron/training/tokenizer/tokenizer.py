...
def build_tokenizer(args, **kwargs):
    ...
    if args.tokenizer_type == 'BertWordPieceLowerCase':
        ...
        tokenizer = _HuggingFaceTokenizer(args.tokenizer_model,  model_max_length=args.seq_length, **kwargs)
...
class _HuggingFaceTokenizer(MegatronTokenizer):
    def __init__(self, pretrained_model_name_or_path, model_max_length=None, **kwargs):
