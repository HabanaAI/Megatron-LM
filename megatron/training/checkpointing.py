...
def load_checkpoint(ddp_model, optimizer, opt_param_scheduler, load_arg='load', strict=True,
    ...
    if args.auto_detect_ckpt_format or ckpt_format == "torch_dist":
        ...
        if ckpt_format is not None and args.ckpt_format != ckpt_format:
            args.ckpt_format = ckpt_format
            print_rank_0(f'Auto-detected checkpoint format: {ckpt_format}. Changing args.ckpt_format accordingly.')
