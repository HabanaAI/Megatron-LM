...
class MockState:
    ...
    def save_parameter_state_by_dp_groups(self, *args, **kwargs):
        pass
...
def create_args():
    ...
    args.ckpt_step = None
    args.save_distrib_optimizer_method = 'serial_per_node'
    args.load_distrib_optimizer_method = 'serial_per_dp_groups'
    args.verify_checkpoint = False
